...
namespace _02___Sample.Manager.Processors
{
    using Base;
    using Domain;
    using Domain.Base;
    ...
    public class PaymentSlipTransactionProcessor : ProcessorBase<PaymentSlipTransaction>, ITransactionProcessor
    {
        ...
        private static TransactionInfo ProcessAuthorization(PaymentSlipTransaction paymentSlipTransaction)
        {
            ...
            return new TransactionInfo(paymentSlipTransaction.TransactionId,
                paymentSlipTransaction.CreateAt, paymentSlipTransaction.Amount,
